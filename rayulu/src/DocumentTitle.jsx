...
const pageTitles = {
  ...
  '/about': 'Top Cleaning and Maintenance Company in Hyderabad - PCS Care',
  ...
  '/blog': 'Expert Cleaning Tips & Industry Insights - PCS Care Blog',
  '/blog-page': 'Comprehensive Blog Platform - PCS Care Articles & Guides',
  '/blog-page/:id': 'Blog Post - PCS Care Professional Insights',
  ...
  '/workstation-cleaning': 'Workstation, Panel, Window Blinds, Rollers Cleaning Services - PCS Care',
  '/login': 'Login - PCS Care Admin Portal',
  '/signup': 'Sign Up - Create Your PCS Care Account',
  '/forgot-password': 'Reset Password - PCS Care Account Recovery',
};
