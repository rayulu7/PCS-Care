...
import CorporateSofaCities from './CorporateSofaCities';
import CorporateSofaAreas from './CorporateSofaAreas';
import CorporateSofaProcess from './CorporateSofaProcess';
import CorporateSofaExpectSection from './CorporateSofaExpectation';
import CorporateSofaQuestions from './CorporateSofaQuestions';





const CorporateSofaTypes = () => {
  const services = [
    {
      id: 1,
      title: "Encapsulation",
  ...
  return (
    ...
    <CorporateSofaExpectSection />
    <ChooseUs />
    <CorporateSofaQuestions />
   </>
  );
};

export default CorporateSofaTypes;