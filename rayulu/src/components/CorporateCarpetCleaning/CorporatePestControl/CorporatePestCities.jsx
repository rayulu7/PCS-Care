  ...
  return (
    <div className="bg-white py-16 px-4">
      ...
      <div className="max-w-7xl mx-auto text-center mb-12">
        ...
        <p className = "text-base mt-4">Our commercial, Industrial and Corporate Office pest control services in India are available in 5 cities currently.</p>
      </div>
...
export default CorporatePestCities;