...
export default function CorporateAreasSection() {
  ...
  return (
    <div className="bg-white py-12 sm:py-16 px-4 sm:px-6">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-12">
        {firstSix.map(area => (
          <Card key={area.name} name={area.name} Icon={area.icon} />
        ))}
      </div>

      {/* last 2 responsive layout */}
