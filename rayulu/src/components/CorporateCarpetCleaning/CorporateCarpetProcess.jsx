...
const CorporateProcessSection = () => {
  const steps = [
    ...
    { number: 2, title: "Prespray for removal of loose dust" },
    { number: 3, title: "Stain Removal" },
    { number: 4, title: "Application of encapsulating/shampooing chemical and agitation" },
    { number: 5, title: "Deep vacuuming to remove encapsulated dust particles" }
  ];
