...
export default function CorporateMarbleForm() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/MarbleService.jpg')", 
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start">
        ...
        <div className="md:w-7/12 text-center md:text-left px-4">
          ...
          <p className="mt-8 text-sm sm:text-base md:text-lg font-bold text-blue-950 leading-relaxed font-poppins">
