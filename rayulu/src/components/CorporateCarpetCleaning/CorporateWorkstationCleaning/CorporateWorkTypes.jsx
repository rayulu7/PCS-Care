...
import CorporateWorkCities from './CorporateWorkCities';
import CorporateWorkAreas from './CorporateWorkAreas';
import CorporateWorkProcess from './CorporateWorkProcess';
import CorporateWorkExpectSection from './CorporateWorkExpectation';
import CorporateWorkQuestions from './CorporateWorkQuestions';





const CorporateWorkTypes = () => {
  const services = [
    {
      id: 1,
      title: "Encapsulation",
...
export default CorporateWorkTypes;